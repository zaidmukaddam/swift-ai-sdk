...
| Reranking | Cohere |
| Image generation | OpenAI (`gpt-image-1`, edits included), fal, Luma, Replicate |
...
Preconfigured endpoints with the AI SDK's exact base URLs and
...
Plus the general initializer for any other chat-completions endpoint.
