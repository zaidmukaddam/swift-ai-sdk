...
| --- | --- |
| [Embeddings](/docs/embeddings) | OpenAI, Azure OpenAI, Cohere, any OpenAI-compatible endpoint |
| [Reranking](/docs/reranking) | Cohere |
| [Image generation](/docs/image-generation) | OpenAI (`gpt-image-2`, edits included), fal, Luma, Replicate |
| [Speech generation](/docs/speech-generation) | OpenAI, ElevenLabs, LMNT, Hume, Deepgram, Sarvam |
| [Transcription](/docs/transcription) | OpenAI, ElevenLabs, Deepgram, AssemblyAI, Rev.ai, Gladia, Sarvam |
| [Video generation](/docs/video-generation) | xAI, Luma |
